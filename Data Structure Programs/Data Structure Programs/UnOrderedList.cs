...
namespace Data_Structure_Programs
{
    class UnOrderedList
    {
        ...
        {
            string text = File.ReadAllText(@"E:\GitDemo\DataStructure-Program\Data Structure Programs\Data Structure Programs\Utility\WordFile.txt");
            ...
            File.WriteAllText(@"E:\GitDemo\DataStructure-Program\Data Structure Programs\Data Structure Programs\Utility\WordFile.txt", textFile);
            list.Display();
        }
    }
}
