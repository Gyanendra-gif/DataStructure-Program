...
namespace Data_Structure_Programs
{
    class OrderedList
    {
        ...
        {
            string text = File.ReadAllText(@"E:\GitDemo\DataStructure-Program\Data Structure Programs\Data Structure Programs\Utility\NumberList.txt");
            ...
            File.ReadAllText(@"E:\GitDemo\DataStructure-Program\Data Structure Programs\Data Structure Programs\Utility\NumberList.txt");
            list.Display();
        }
    }
}
